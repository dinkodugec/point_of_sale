...
<div class="text-start mt-3">
    ...
    <p class="text-muted mb-2 font-13"><strong>{{ $adminData->name }}</strong></p>

    <p class="text-muted mb-2 font-13"><strong>{{ $adminData->phone }}</strong></p>

    <p class="text-muted mb-2 font-13"><strong>{{ $adminData->email }}</strong></p>
