...
<a href="{{ route('delete.supplier',$item->id) }}" class="btn btn-danger rounded-pill waves-effect waves-light" title="Delete" id="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
