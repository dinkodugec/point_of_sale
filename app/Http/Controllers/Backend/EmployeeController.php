...
class EmployeeController extends Controller
{
    ...
    public function StoreEmployee(Request $request)
    {
        $validateData = $request->validate([
            ...
            'email' => 'required|unique:employees|max:200', //unique for employees tabel in db
        ...
        Image::make($image)->resize(300,300)->save('upload/employee/'.$name_gen);  /* make() image from request file('image'), resize it to 300*300 and save it in folder*/
    ...
    public function UpdateEmployee(Request $request)
    {
        ...
        if ($request->file('image')) {  //with image
